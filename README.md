...
The package is currently under active development and installed from GitHub:
```
devtools::install_github("giobuzala/surveyorso")
```
Function interfaces may change, and documentation is evolving alongside the codebase.
